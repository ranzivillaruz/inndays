...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['editPropertyId'])) {
    ...
    $province = $conn->real_escape_string($_POST['editProvince']);
    $city = $conn->real_escape_string($_POST['editCity']);
    $barangay = $conn->real_escape_string($_POST['editBarangay']);
...
<body>
            ...
            <tbody class="listings-table-body">
                ...
                if ($result->num_rows > 0) {
                    ...
                    <button class='edit-button' 
                        ...
                        data-province='" . htmlspecialchars($row['property_province'] ?? '') . "'
                        data-city='" . htmlspecialchars($row['property_city'] ?? '') . "'
                        data-barangay='" . htmlspecialchars($row['property_barangay'] ?? '') . "'
                        data-address='" . htmlspecialchars($row['property_address'] ?? '') . "'>
                        Edit
                    </button>
    ...
    <div id="editModal">
        ...
        <form id="editForm" method="POST" action=""> <input type="hidden" name="editPropertyId" id="editPropertyId">
            ...
            <input type="text" name="editProvince" id="editProvince" required><br>

            <label for="editCity">City:</label>
            <input type="text" name="editCity" id="editCity" required><br>

            <label for="editBarangay">Barangay:</label>
            <input type="text" name="editBarangay" id="editBarangay" required><br>

            <label for="editAddress">Address:</label>
            <textarea name="editAddress" id="editAddress" rows="4" required></textarea><br>
    ...
    <script>
        ...
        function openEditModal(property_id, title, desc, price, type, availability, province, city, barangay, address) {
        ...
        document.querySelectorAll('.edit-button').forEach(button => {
            button.addEventListener('click', function (event) {
                ...
                openEditModal(property_id, title, desc, price, type, availability, province, city, barangay, address);
            });
        });
